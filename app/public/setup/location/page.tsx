...
export default function LocationSetupPage() {
  ...
  const selectClass =
    "w-full appearance-none rounded-[var(--dl-radius-sm)] border border-white/15 bg-white/5 px-4 py-3.5 text-base text-white transition focus:border-[var(--dl-orange)] focus:ring-2 focus:ring-[var(--dl-orange)]/30 focus:outline-none";

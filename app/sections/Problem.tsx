        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {PROBLEMS.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 0.08} className="h-full">
              <div className="bg-white/5 border border-slate-800 rounded-xl p-7 hover:-translate-y-1.5 hover:border-slate-700 hover:bg-white/[0.07] transition-all duration-300 h-full">
                <div className="w-[52px] h-[52px] rounded-lg bg-[var(--orange)]/10 text-[var(--orange)] flex items-center justify-center mb-5">

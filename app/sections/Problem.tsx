        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {PROBLEMS.map((item, i) => (
            <ScrollReveal key={item.title} delay={i * 0.08} className="h-full">
              <div className="bg-[#F8FAFC] border border-[#E7ECF3] rounded-[18px] p-7 hover:-translate-y-1.5 hover:shadow-[var(--shadow-soft)] hover:border-[var(--gray-2)] transition-all duration-300 h-full">

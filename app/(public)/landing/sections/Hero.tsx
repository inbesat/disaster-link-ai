  ...
  return (
    <section className="min-h-screen flex items-center relative overflow-hidden">
      <div 
        ...
        style={{ background: 'radial-gradient(circle at 18% 20%, #12335e 0%, #0B1F3A 46%, #081527 100%)' }}
      />
      <div 
        ...
        <div>
          ...
          <ScrollReveal delay={0.2}>
            <p className="text-lg text-[#C9D6EC] mt-6 max-w-xl leading-relaxed">
              DisasterLink AI predicts disasters before they strike and delivers critical alerts across 9 communication channels — reaching every citizen, even in the most remote villages, within seconds.
            </p>
          </ScrollReveal>
            ...
            <div className="flex flex-wrap gap-8 mt-12">
              {[
                ...
                <div key={idx} className="flex flex-col">
                  ...
                  <span className="text-xs text-[#C9D6EC] uppercase tracking-wider mt-1">{stat.label}</span>
                </div>
              ))}
            </div>
          </ScrollReveal>
          ...
          <div className="bg-white/[0.06] border border-white/[0.14] backdrop-blur-[18px] rounded-[22px] p-5 relative z-10">
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-semibold tracking-widest text-white/70">LIVE NATIONAL FEED</span>
              </div>
            ...
            <div className="h-[200px] relative flex items-center justify-center bg-[rgba(37,99,235,0.05)] rounded-xl overflow-hidden">
              <div className="absolute w-[160px] h-[160px] rounded-full border border-white/10 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 animate-ping" style={{ animationDuration: '4s' }} />

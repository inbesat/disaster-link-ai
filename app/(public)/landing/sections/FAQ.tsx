...
export default function FAQ() {
  ...
  return (
    <section className="bg-[#F8FAFC] py-28">
      <SectionHead eyebrow="FAQ" eyebrowVariant="blue" title="Common questions" center={true} />

      <div className="max-w-[820px] mx-auto px-6 mt-12 space-y-4">
        {faqs.map((faq, i) => (
          <div key={i} className="bg-white border border-[#E7ECF3] rounded-[14px] overflow-hidden">
            <button 

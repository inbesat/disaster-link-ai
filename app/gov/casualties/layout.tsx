...
// ---------------------------------------------------------------------
// app/gov/casualties/layout.tsx — Casualty Tracking shell.
//
// Wraps the Casualty Tracking Registry in the same Phase 2 DashboardShell
// (sidebar rail + top bar + mobile nav) as the Command Center and Resource
// Inventory, so the casualty workspace gets the identical tactical chrome.
...
export default function GovCasualtiesLayout({ children }: { children: ReactNode }) {

          ...
          <label
            className={`flex cursor-pointer items-start gap-3 rounded-md border p-4 transition ${
              selected === "hard"
                ...
                : "border-[#1c2740] bg-surface-muted/40 hover:border-red-500/40"
            }`}
          >
            <input
              type="radio"
        ...
        >
          <div className="w-full max-w-md rounded-eoc border-2 border-red-600/60 bg-surface p-6 shadow-2xl">
            ...
            <input
              ...
              autoComplete="off"
              autoFocus
              className="mt-2 w-full rounded-md border border-[#1c2740] bg-[#0a0f1d] px-3 py-2.5 font-mono text-sm font-bold tracking-wider text-slate-100 outline-none placeholder:text-slate-600 focus:border-red-400/60"
            />

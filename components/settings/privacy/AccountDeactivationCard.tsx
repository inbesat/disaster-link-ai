        ...
        >
          <div className="w-full max-w-md rounded-eoc border-2 border-red-600/60 bg-surface p-6 shadow-2xl">
            ...
            <input
              ...
              autoComplete="off"
              autoFocus
              className="mt-2 w-full rounded-md border border-panel-border bg-[#0a0f1a] px-3 py-2.5 font-mono text-sm font-bold tracking-wider text-slate-100 outline-none placeholder:text-slate-600 focus:border-red-400/60"
            />

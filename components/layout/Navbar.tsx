...
/** Supported languages for the Google Translate cookie-based toggle. */
const LANGUAGES = [
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Right: CTAs + language toggle + mobile toggle */}
        <div className="navbar-end gap-2">
          {/* Language Toggle — Google Translate cookie-based */}
          <div className="relative group">
            <button
              className="btn btn-ghost hidden md:inline-flex rounded-full border border-white/20 text-white px-3 py-2 text-sm font-medium hover:bg-white/10 hover:border-white/30 transition-all duration-200 normal-case font-sans items-center gap-1.5"
              aria-label="Select language"
            >
              <Globe size={14} aria-hidden="true" />
              <span className="text-xs font-bold">{LANGUAGES.find(l => l.code === activeLang)?.native ?? "EN"}</span>
            </button>
            {/* Dropdown */}
        ...
        {menuOpen && (
          ...
          >
            ...
            <div className="flex flex-col gap-3 mt-4 px-2">
              ...
              <div className="flex items-center justify-center gap-2 border border-white/20 rounded-full py-2 px-3">
                <Globe size={14} className="text-white" aria-hidden="true" />

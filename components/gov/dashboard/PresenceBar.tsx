...
function Avatar({ user }: { user: PresenceUser }) {
  return (
    <span
      ...
      className="group relative flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-[0.625rem] font-bold text-white ring-2 ring-[#0a0f1a] transition hover:z-10 hover:-translate-y-0.5"
      style={{
  ...
  return (
    <div className="flex items-center gap-2.5" aria-label="People viewing this dashboard">
      <div className="flex items-center -space-x-2">
        ...
        {overflow > 0 && (
          <span
            ...
            className="flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-[0.625rem] font-bold text-white/80 ring-2 ring-[#0a0f1a]"
          >
            +{overflow}
          </span>
        )}
      ...
      <div className="hidden flex-col items-start leading-none md:flex">
        <p className="flex items-center gap-1.5 text-[0.6875rem] font-semibold text-white/90">

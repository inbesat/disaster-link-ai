  ...
  return (
    <GovMapLayersProvider>
      <div className="gov-ops-map relative h-screen w-screen overflow-hidden bg-[#0a0f1a]">
        ...
        <div className="pointer-events-none absolute bottom-4 left-4 z-10 flex items-center gap-2 rounded-full bg-[#0d1526]/80 px-3 py-1.5 text-[11px] font-medium text-white/80 backdrop-blur">
